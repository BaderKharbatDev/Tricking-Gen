...
-(id)init {
    ...
    if(self) {
        ...
        NSMutableArray * pop_kicks = [[NSMutableArray alloc] init];
            {
                ...
                [pop_kicks addObject: [[Move alloc] init:@"Pop forwards60" : chest_back : chest_back ]];
                [pop_kicks addObject: [[Move alloc] init:@"Backside 900" : backwards : chest_back ]];
                [pop_kicks addObject: [[Move alloc] init:@"Pop 7chest_back0 Hook" : chest_back : chest_forward ]];
            }
        NSMutableArray * cheat_kicks = [[NSMutableArray alloc] init];
            {
                [cheat_kicks addObject: [[Move alloc] init:@"Tornado" : chest_back : chest_back ]];
                [cheat_kicks addObject: [[Move alloc] init:@"Paraduso" : chest_back : chest_back ]];
                [cheat_kicks addObject: [[Move alloc] init:@"5backwards0" : chest_back : chest_forward ]];
                [cheat_kicks addObject: [[Move alloc] init:@"Cheat 7chest_back0" : chest_back : chest_forward ]];
        ...
        NSMutableArray * flat_twists = [[NSMutableArray alloc] init];
            {
                [flat_twists addObject: [[Move alloc] init:@"Btwist" : chest_forward : chest_back ]];
        ...
        NSMutableArray * backward_flips = [[NSMutableArray alloc] init];
            {
                ...
                [backward_flips addObject: [[Move alloc] init:@"Gainer Arabian" : backwards : forwards ]];
        ...
        NSMutableArray * backward_twists = [[NSMutableArray alloc] init];
            {
                ...
                [backward_twists addObject: [[Move alloc] init:@"Doubel Full" : backwards : backwards ]];
        ...
        NSMutableArray * forward_flips = [[NSMutableArray alloc] init];
            {
                ...
                [forward_flips addObject: [[Move alloc] init:@"Front Russian Front" : forwards : backwards ]];
                [forward_flips addObject: [[Move alloc] init:@"Front Half" : forwards : backwards ]];
                [forward_flips addObject: [[Move alloc] init:@"Webster Half" : forwards : forwards ]];
            }
        NSMutableArray * forward_twists = [[NSMutableArray alloc] init];
        {
            [forward_twists addObject: [[Move alloc] init:@"forwards60 Dive Roll" : forwards : forwards ]];
        }
        NSMutableArray * outside_flips = [[NSMutableArray alloc] init];
        {
            [outside_flips addObject: [[Move alloc] init:@"Dleg" : chest_back : backwards ]];
            [outside_flips addObject: [[Move alloc] init:@"Gumbi" : forwards : backwards ]];
            [outside_flips addObject: [[Move alloc] init:@"Raiz" : forwards : backwards ]];
            [outside_flips addObject: [[Move alloc] init:@"TDR" : forwards : backwards ]];
            [outside_flips addObject: [[Move alloc] init:@"Sailor Moon" : forwards : backwards ]];
        }
        NSMutableArray * outside_twists = [[NSMutableArray alloc] init];
        {
            [outside_twists addObject: [[Move alloc] init:@"Snapu" : forwards : chest_back ]];
        }
...
-(Move *) randomMove {
    NSMutableArray * activeMoves = [self getActiveMoveList];
    int r = arc4random_uniform(activeMoves.count);
