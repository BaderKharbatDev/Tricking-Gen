...
@implementation Move
NSString * moveFileTitle = @"movedata";
NSString * moveFile = @"movedata.plist";
...
+(NSMutableArray *) propListGetMove: (Operation) operation : (NSString *) name {
    ...
    NSString *plistPath = [documentsPath stringByAppendingPathComponent: moveFile];
    NSFileManager * fileManager = [NSFileManager defaultManager];
    if(!([fileManager fileExistsAtPath: plistPath])) {
        NSString * bundlePath = [[NSBundle mainBundle] pathForResource: moveFileTitle ofType:@"plist"];
        @try {
